...
function UserAction() {
    if (AddTweet.isAuthenticated) {
        return <button type="button" class="btn btn-danger" onClick={async () => { await logout(); client.clearStore()}}>Logout</button>
    } else {
            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none me-4">
                        ...
                        <span class="logo-title">Workshop Challenge</span>
                    </a>
